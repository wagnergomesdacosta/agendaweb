  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="/agendaweb/tarefas-consulta">Consultar Tarefas</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="/agendaweb/tarefas-cadastro">Cadastrar Tarefas</a>
        </li>
  	 </ul>
      </div>
  </div>
...
<div style="border-botton: 1px solid #eee; background-color: #fafafa;">
	<div class="container" >
		<div class="row mb-2">
